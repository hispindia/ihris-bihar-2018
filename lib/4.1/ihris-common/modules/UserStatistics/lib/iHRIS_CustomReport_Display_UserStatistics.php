...
class iHRIS_CustomReport_Display_UserStatistics extends I2CE_CustomReport_Display_Default {
    ...
    protected function getResults($check_restart = true) {
        ...
        $num_rows = $db->queryRow( "SELECT COUNT(*) AS num_rows FROM zebra__user_statistics $where $group_by" );
   ...
   /**
     ...
     * @param MDB2_Row $result A result row with variables of the form "$field"  with unmapped value
