...
//        if (!$this->hasHeader() && $header == $this->getDefaultHeader()) {
    ...
    public function processValues($vals) {
        ...
        $keys = array('link_url'=>'link','link_append'=>'link_append','link_type'=>'link_type');
    ...
    public function displayValues($contentNode, $transient_options, $action) {
        ...
        $inputs = array('field_submit','enabled','header','link_url','link_append','link_type','limit_default');
        if ($action == 'edit') {
