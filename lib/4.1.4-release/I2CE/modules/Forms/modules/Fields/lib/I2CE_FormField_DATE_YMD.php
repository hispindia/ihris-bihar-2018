 ...
 * @access public
 */
class I2CE_FormField_DATE_YMD extends I2CE_FormField_DB_DATE { 
    ...
    public function processDOMEditable($node,$template,$form_node) {
        ...
        if ($this->use_date_picker) {
            ...
            $element = $template->createElement( "input", array( "class"=>"datepicker_ymd", "name" => $ele_name, "type" => "text", "value" => $date));
            $this->setElement($element);
            $node->appendChild($element);
            $args=array(
                'format'=>'F j, Y', //name of day short textuyal month, day 4 digit year
                'inputOutputFormat'=> 'Y-m-d',  //4-digit year, 2-digit month, 2-digit day
   ...
   /**
    ...
    public function setValue( $value ) {
        ...
        $this->value->setType(I2CE_Date::DATE);
    }
