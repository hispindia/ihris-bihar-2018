...
class I2CE_Mailer {
     ...
     */
    public static function mail($recipients, $headers, $body, $html =false) {
        if (self::$method === null) {
            self::initMailer();
        }
        ...
        switch (self::$method) {
        case 'pear':
            return self::mail_pear($recipients, $headers, $body,$html);
        case 'localhost':
    ...
    protected static function mail_pear($recipients, $headers, $body,$html = false) {
        try {
            if ($html) {
