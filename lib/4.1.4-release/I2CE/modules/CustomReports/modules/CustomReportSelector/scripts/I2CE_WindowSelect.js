var I2CE_WindowSelect = new Class({
	...
	var url = 'index.php/stub/id?request=' + Stub.urlencode(request) +  '&content=' + this.options.contentid+ '&keep_javascripts=' + Stub.urlencode('stub_events,formworm,treeselect');
	new Request.HTML(
	    {
		url :  url,
		update: this.content,
