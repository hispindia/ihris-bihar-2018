        ...
        if ($this->page == 'saveForm' && $id > 0 && $this->isPost()) {
            ...
            if ($formObj instanceof I2CE_Form) {
                ...
                if ($this->saveForm($formObj)) {
                    $this->userMessage("Form succesfully updated");
                } else {
                    $this->userMessage("Form not succesfully updated");
                    $this->page = 'editForm';
                }
            } else {
                    $this->userMessage("Form not succesfully updated -- form could not be created");
                    $this->page = 'editForm';
            }
            $editForm = false;
        }
