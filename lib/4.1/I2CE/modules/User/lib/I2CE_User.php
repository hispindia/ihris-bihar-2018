...
if (!class_exists('I2CE_User',false)) {
    class I2CE_User  extends I2CE_Fuzzy{
        ...
        /**
         *  @var protected mixed $ip_address.  The IP Address from which this user is accessing the system. 
         */
        ...
        public function __construct( $username = '0', $populate = true , $checkSession = true, $log = true ) {
            ...
            if ($log) {
                $userAccess->logActivity($this->username,'access', $this->ip_address);
            }
        ...
        public function login( $username, $password ) {
            ...
            if (! $userAccess->userHasPassword($username,$password)) {
                $userAccess->logActivity($username,'invalid_login',$this->ip_address);
                return "Invalid Username or Password";
            }
            
            
            if( $userAccess->isLoggingFromAnotherIP($username, $this->ip_address) ){
                return "Logout from the other PC before you continue.";
            }
            ...
            $userAccess->logActivity($username,'login', $this->ip_address);
            return true;
        }
