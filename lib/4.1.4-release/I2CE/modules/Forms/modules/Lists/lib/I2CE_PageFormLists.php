...
class I2CE_PageFormLists extends I2CE_PageForm {
    ...
    protected function getPrimaryHTMLTemplate() {
        if ($this->getPrimary() instanceof I2CE_list) {
            return $this->getPrimary()->getHTMLTemplate();
        } else {
            return true;
        }
    }
    ...
    /**
     * @var protected booelan $show_hidden.  Whether or not to show hidden elements
     */
    protected $show_hidden = null;
    ...
    protected function showHidden() {
        if (!is_bool($this->show_hidden)) {
            $this->show_hidden =(bool) (
                $this->request_exists('show_i2ce_hidden') && 
                $this->request('show_i2ce_hidden') == 1 && 
                $this->hasPermission('task(can_hide_list_members) '));
        }
    ...
    protected function setDisplayData() {
        ...
        $this->template->setDisplayData('show_i2ce_hidden',$this->showHidden());
