 ...
 */
    class I2CE_TemplateMeister extends I2CE_Fuzzy{
         ...
         */
        public function appendNodeByName( $node, $name, $occurrence,$relative_node = null ) {
            $parent = $this->getElementByName( $name, $occurrence,$relative_node );
            if ($parent instanceof DOMNode) {
                return $this->appendNode( $node, $parent );
            }
        }
         ...
         */
        public function appendFileByName( $contentfile, $tag, $parent_name, $occurrence = 0,$node = null ) {
            $imported = $this->loadFile( $contentfile, $tag );
            return $this->appendNodeByName( $imported, $parent_name, $occurrence,$node );
        }
        /**
