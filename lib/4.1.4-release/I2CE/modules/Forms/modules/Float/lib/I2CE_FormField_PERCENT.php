 ...
 * @access public
 */
class I2CE_FormField_PERCENT extends I2CE_FormField_FLOAT { 
    ...
    public function postprocessDOMEditable( $node, $template, $form_node ) {
        ...
        foreach ($inputs as $input) {
            ...
            $input->setAttribute('onchange','I2CE_InputFormatter.format(this,"percentage",2' . $validation .')');
        }
    }
  }
